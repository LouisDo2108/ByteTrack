...
# from ByteTrack.yolox.sort_tracker.sort import Sort
# from ByteTrack.yolox.deepsort_tracker.deepsort import DeepSort
# from ByteTrack.yolox.motdt_tracker.motdt_tracker import OnlineTracker
...
class MOTEvaluator:
    ...
    #         # run tracking
    #         img_size = [info_imgs[0].item(), info_imgs[1].item()]
    #         online_targets = tracker.update(outputs[0], img_size, self.img_size)
    #         online_tlwhs = []
    #         online_ids = []
    #         for t in online_targets:
